...
contexto = carga("datos/HeadbangerAI.txt")
...
def bot(prompt):
    ...
    while True:
        try:
            ...
            prompt_sistema = f""" 
                                # PERSONA
                                Eres un chatbot especializado en conciertos de rock a nivel mundial.. No debes
                                responder preguntas que no sean sobre conciertos de rock.
